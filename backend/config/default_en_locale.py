...
DEFAULT_DICTIONARY = {
    ...
    "spam": {
        ...
        "card": {
            ...
            "allowlist_placeholder": "e.g., clips.kick.com, youtube.com",
        ...
        "filters": {
            ...
            "paragraph": {
                "title": "Long Walls of Text",
                "desc": "Blocks excessively long messages or walls of text (Max character limit)."
            },
            "symbol": {
                "title": "Symbols & Foreign Script Protection",
                "desc": "Filters non-Latin scripts (Arabic, Zalgo, Cyrillic) or symbol spam, ignoring valid Kick emotes."
            },
            "repetition": {
    ...
    "chat": {
        ...
        "roles": {
            ...
            "moderator_desc": "Voice used for moderators' messages.",
            "vip_title": "VIP Voice",
    ...
    "music": {
        ...
        "youtube": {
            ...
            "generic_error": "Could not process audio for this video."
        },
        "overlay": {
            ...
            "layout_banner": "Banner Header (Large Artwork)",
            "layout_pill": "Minimal Capsule (Pill Bar)",
            "layout_floating": "Vinyl Record (Retro Spin)",
            "layout_compact": "Compact Card",
            "layout_standard": "Standard Bar",
            "theme_dynamic": "Dynamic (Auto-Album Colors)",
            "theme_glass": "Glassmorphism",
            "theme_minimal": "Minimalist",
    ...
    "dialogs": {
        ...
        "unlink": {
            "title": "Unlink Account",
            "desc": "Are you sure you want to log out? You will need to re-authorize MiniKick next time."
        },
        "close": {
    ...
    "timer": {
        ...
        "table": {
            ...
            "col_interval_offline": "Interval Offline",
            "col_chat_lines": "Chat Lines",
            "col_actions": "Actions",
        ...
        "dialog": {
            ...
            "chat_lines_label": "Min Chat Lines",
            "chat_lines_desc": "Minimum amount of chat messages required in the last 5 minutes to activate the timer.",
            "keywords_label": "Stream title keywords (comma-separated):",
            "keywords_placeholder": "e.g., giveaway, special",
            "keywords_desc": "Enable the timer only when the stream title contains one or more keywords.",
        ...
        "status": {
            ...
            "created_msg": "Timer '{name}' has been successfully created.",
            "updated": "Timer Updated",
            "updated_msg": "Timer '{name}' has been successfully updated.",
    ...
    "widgets": {
        ...
        "so": {
            ...
            "usage_error": "⚠️ @{user}, you must specify the streamer name. Example: {trigger} TheAndro2K",
        ...
        "death": {
            ...
            "msg_add": "💀 @{user} added a death! Total: {count} death(s).",
            "msg_sub": "💀 @{user} removed a death. Remaining: {count} death(s).",
        ...
        "score": {
            ...
            "overlay_title": "WIN / LOSS RECORD",
            "msg_check": "🏆 @{user}, today's record is: {wins} W - {losses} L.",
    ...
    "crash": {
        ...
        "placeholder_contact": "E.g., TheAndro2K",
