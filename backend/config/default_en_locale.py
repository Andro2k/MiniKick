...
DEFAULT_DICTIONARY = {
    ...
    "timer": {
        "dialog": {
            ...
            "chat_lines_label": "Minimum Chat Messages",
            ...
            "response_label": "Response messages (one will be selected randomly):",
            "response_placeholder": "Enter response message here...",
            "subtitle": "Schedule a recurring message to share your social links, rules, or announcements in chat.",
