...
from frontend.common.theme import COLOR_ACCENT, COLOR_BG_INPUT, COLOR_BG_SURFACE, COLOR_BORDER_SVELTE, RADIUS_MD, RADIUS_SM
...
class ModernSwitch(QAbstractButton):
    ...
    def paintEvent(self, event):
        ...
        painter.setBrush(QColor(COLOR_BG_SURFACE) if self.isChecked() else QColor("#ffffff"))
