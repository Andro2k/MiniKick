...
class WidgetsView(BaseView):
    ...
    def __init__(self, i18n, shoutout_overlay_url: str = "", death_overlay_url: str = "", score_overlay_url: str = ""):
    ...
    def set_overlay_urls(self, shoutout_url: str = "", death_url: str = "", score_url: str = ""):
