...
COLOR_NEUTRAL_950  = "#090909"
COLOR_NEUTRAL_900  = "#121212"
COLOR_NEUTRAL_850  = "#181818"
COLOR_NEUTRAL_800  = "#272727"
COLOR_NEUTRAL_750  = "#292929"
COLOR_NEUTRAL_700  = "#3F3F3F"
COLOR_NEUTRAL_500  = "#717171"
COLOR_NEUTRAL_400  = "#A1A1A1"
COLOR_NEUTRAL_200  = "#E4E4E4"
COLOR_WHITE        = "#FAFAFA"
COLOR_BLACK        = "#000000"
...
/* ==============================================================================
   ...
   ============================================================================== */
QLineEdit, QTextEdit, QPlainTextEdit {{ background-color: {COLOR_NEUTRAL_850}; color: {COLOR_NEUTRAL_400}; font-weight: 400; border-radius: {RADIUS_MD}px; padding: {PADDING_INPUT}; border: 1.5px solid {COLOR_NEUTRAL_800}; }}
...
QComboBox {{ background-color: {COLOR_NEUTRAL_850}; color: {COLOR_NEUTRAL_400}; font-weight: 400; border-radius: {RADIUS_MD}px; padding: {PADDING_INPUT}; border: 1.5px solid {COLOR_NEUTRAL_800}; combobox-popup: 0; }}
QComboBox:focus, QComboBox:hover {{ background-color: {COLOR_NEUTRAL_800}; }}
...
QComboBox QAbstractItemView, QMenu {{ background-color: {COLOR_NEUTRAL_900}; color: {COLOR_NEUTRAL_400}; border: 1.5px solid {COLOR_NEUTRAL_800}; border-radius: {RADIUS_MD}px; padding: 3px 2px; selection-background-color: {COLOR_NEUTRAL_800}; selection-color: {COLOR_GREEN}; }}
...
QMenu::item {{ padding: 4px 12px 4px 18px; margin: 1px 2px; border-radius: {RADIUS_SM}px; color: {COLOR_NEUTRAL_400}; font-size: 12px; }}
...
QSpinBox, QDoubleSpinBox, QTimeEdit {{ background-color: {COLOR_NEUTRAL_850}; color: {COLOR_NEUTRAL_400}; font-weight: 400; border-radius: {RADIUS_MD}px; padding: 3px 24px 3px 8px; border: 1.5px solid {COLOR_NEUTRAL_800}; selection-background-color: transparent; selection-color: {COLOR_NEUTRAL_400}; }}
...
QDateEdit {{ background-color: {COLOR_NEUTRAL_850}; color: {COLOR_NEUTRAL_400}; font-weight: 400; border-radius: {RADIUS_MD}px; padding: 3px 24px 3px 8px; border: 1.5px solid {COLOR_NEUTRAL_800}; selection-background-color: transparent; selection-color: {COLOR_NEUTRAL_400}; }}
...
QCalendarWidget QToolButton {{ background-color: transparent; color: {COLOR_WHITE}; font-weight: 600; font-size: 13px; border: 1.5px solid transparent; border-radius: {RADIUS_SM}px; padding: 4px 8px; margin: 2px; }}
...
QCalendarWidget QMenu {{ background-color: {COLOR_NEUTRAL_900}; color: {COLOR_NEUTRAL_400}; border: 1.5px solid {COLOR_NEUTRAL_800}; border-radius: {RADIUS_MD}px; padding: 4px; }}
...
QScrollBar::handle:vertical {{ background-color: {COLOR_NEUTRAL_800}; border-radius: 4px; min-height: 30px; }}
...
QScrollBar::handle:horizontal {{ background-color: {COLOR_NEUTRAL_800}; border-radius: 4px; min-width: 30px; }}
...
QProgressBar {{ background-color: {COLOR_NEUTRAL_850}; border: 1.5px solid {COLOR_NEUTRAL_800}; border-radius: 4px; height: 6px; text-align: center; }}
...
/* ==============================================================================
   ...
   ============================================================================== */
QFrame[role="card"] {{ background-color: {COLOR_NEUTRAL_900}; border: 1.5px solid {COLOR_NEUTRAL_750}; border-radius: {RADIUS_LG}px; }}
QFrame[role="dialog"] {{ background-color: {COLOR_NEUTRAL_950}; border: 1.5px solid {COLOR_NEUTRAL_750}; border-radius: 16px; }}
...
QFrame[role="banner_danger"] QLabel {{ color: {COLOR_NEUTRAL_400}; }}
...
QFrame[role="toast"] {{ background-color: {COLOR_BLACK}; border: 1.5px solid {COLOR_NEUTRAL_800}; border-radius: {RADIUS_MD}px; }}
QFrame[role="toast"][state="success"] {{ border-color: {COLOR_GREEN_GLOW}; }}
...
QFrame[role="badge"] QLabel {{ font-size: {size_textline_3}px; font-weight: 700; color: {COLOR_NEUTRAL_400}; background: transparent; }}
...
QTextEdit[role="ConsoleDisplay"] {{ background-color: {COLOR_NEUTRAL_950}; color: {COLOR_NEUTRAL_400}; border: 1.5px solid {COLOR_NEUTRAL_750}; border-radius: {RADIUS_MD}px; }}
QTextBrowser[role="release_notes_browser"] {{ background-color: {COLOR_NEUTRAL_950}; color: {COLOR_NEUTRAL_400}; border: 1.5px solid {COLOR_NEUTRAL_750}; border-radius: {RADIUS_MD}px; padding: 12px; }}

/* ==============================================================================
   5. SISTEMA DE TIPOGRAFÍA DE TEXTOS (Con Role)
   ============================================================================== */
QLabel[role="h1"] {{ font-size: {size_headline_1}px; font-weight: 400; color: {COLOR_NEUTRAL_400}; }}
QLabel[role="h2"] {{ font-size: {size_headline_2}px; font-weight: 400; color: {COLOR_NEUTRAL_400}; }}
...
/* ==============================================================================
   ...
   ============================================================================== */
QPushButton {{ border: 1.5px solid transparent; }}
QPushButton:focus {{ border: 1.5px solid {COLOR_GREEN}; }}
QPushButton[role="nav_button"] {{ background: transparent; border-radius: {RADIUS_MD}px; padding: 10px; text-align: left; color: {COLOR_NEUTRAL_400}; font-weight: 500; border: 1.5px solid transparent; }}
...
QPushButton[role="action_outlined"] {{ background-color: {COLOR_NEUTRAL_850}; color: {COLOR_NEUTRAL_400}; font-size: {size_textline_1}px; font-weight: 700; border: 1.5px solid {COLOR_NEUTRAL_800}; border-radius: {RADIUS_MD}px; padding: {PADDING_BUTTON}; }}
...
QPushButton[role="action_neutral_border"] {{ background-color: {COLOR_NEUTRAL_850}; color: {COLOR_NEUTRAL_400}; font-size: {size_textline_1}px; font-weight: 700; border: 1.5px solid {COLOR_NEUTRAL_800}; border-radius: {RADIUS_MD}px; padding: {PADDING_BUTTON}; }}
...
QPushButton[role="btn_ghost"] {{ background-color: transparent; border: 1.5px solid transparent; border-radius: {RADIUS_SM}px; padding: 2px; }}
...
QPushButton[role="segmented_item"] {{ background-color: transparent; border: 1.5px solid transparent; border-radius: {RADIUS_SM}px; padding: 3px 5px; }}
...
/* ==============================================================================
   ...
   ============================================================================== */
QPushButton:disabled, QPushButton[role="action_accent"]:disabled, QPushButton[role="action_outlined"]:disabled, QPushButton[role="action_danger_border"]:disabled, QPushButton[role="action_accent_border"]:disabled, QPushButton[role="action_neutral_border"]:disabled, QPushButton[role="btn_ghost"]:disabled {{ background-color: {COLOR_WHITE_GLOW}; color: {COLOR_NEUTRAL_500}; border: 1.5px solid {COLOR_NEUTRAL_800}; padding: {PADDING_BUTTON}; }}
QLineEdit:disabled, QTextEdit:disabled, QComboBox:disabled, QSpinBox:disabled, QDoubleSpinBox:disabled {{ background-color: {COLOR_WHITE_GLOW}; color: {COLOR_NEUTRAL_500}; border-color: {COLOR_NEUTRAL_800}; padding: {PADDING_INPUT}; }}
QCheckBox:disabled {{ color: {COLOR_NEUTRAL_500}; }}

/* ==============================================================================
   8. COMPONENTES COMPUESTOS (Search Bar y Segmented Pagination)
   ============================================================================== */
QFrame[role="search_bar"] {{ background-color: {COLOR_NEUTRAL_850}; border: 1.5px solid {COLOR_NEUTRAL_750}; border-radius: {RADIUS_MD}px; }}
...
QFrame[role="search_bar"] QPushButton {{ background: transparent; border: none; border-left: 1.5px solid {COLOR_NEUTRAL_750}; border-top-right-radius: {RADIUS_MD - 2}px; border-bottom-right-radius: {RADIUS_MD - 2}px; min-width: 36px; max-width: 36px; min-height: 32px; max-height: 32px; }}
...
QFrame[role="segmented_pagination"] {{ background-color: {COLOR_NEUTRAL_850}; border: 1.5px solid {COLOR_NEUTRAL_750}; border-radius: {RADIUS_MD}px; }}
QFrame[role="segmented_pagination"] QPushButton {{ background: transparent; border: none; border-left: 1.5px solid {COLOR_NEUTRAL_750}; min-width: 32px; max-width: 32px; min-height: 32px; max-height: 32px; }}
