...
QPushButton[role="action_outlined"] {{ background-color: {COLOR_BG_INPUT}; color: {COLOR_TEXT_PRIMARY}; font-size: {btn_txt}px; font-weight: 700; border: none; border-radius: {RADIUS_MD}px; padding: 7px 16px; }}
...
QComboBox {{ background-color: {COLOR_BG_INPUT}; color: {COLOR_TEXT_PRIMARY}; font-size: {base}px; font-weight: 400; border-radius: {RADIUS_MD}px; padding: 5px 28px 5px 10px; border: 1.5px solid transparent; }}
...
QLabel[role="pill_text"] {{ color: {COLOR_TEXT_PRIMARY}; font-size: {caption}px; font-weight: 600; background: transparent; }}
...
QLabel[role="badge_regex_text"] {{ color: {COLOR_WARNING}; font-size: {badge_txt}px; font-weight: bold; }}
"""
