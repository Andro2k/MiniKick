...
class TikTokConnectDialog(ModernModal):
    ...
    def _setup_ui(self, initial_target: str):
        lbl_desc = QLabel(self.i18n.get("dialogs.tiktok_connect.desc"))
        ...
        self.txt_target.setPlaceholderText(self.i18n.get("dialogs.tiktok_connect.placeholder"))
        if initial_target:
            self.txt_target.setText(initial_target)
        self.txt_target.textChanged.connect(self._validate_input)

        self.btn_clear = ModernButton(self.i18n.get("dialogs.tiktok_connect.btn_clear"), role="action_danger_border")
        ...
        self.btn_connect = ModernButton(self.i18n.get("dialogs.tiktok_connect.btn_connect"), role="action_tiktok")
    ...
    def get_target(self) -> str:
        return self.txt_target.text().strip().lstrip("@")
