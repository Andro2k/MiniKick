...
- **[FEATURE] [SYSTEM] Captura y Diagnóstico Automatizado de Crashes con Faulthandler:** Integración de volcado de memoria multi-hilo en tiempo real capturando fallos nativos C/C++ y adjuntándolos automáticamente con el nombre de usuario y versión en los reportes de crash enviados por webhook.

---

### Mejoras (8)

- **[IMPROVEMENT] [PLATFORMS] Control Reactivo de Conexión en Rewards, Comandos, Timers, Filtros Anti-Spam e Información del Stream:** Los asistentes y vistas de creación/edición ahora detectan y reflejan el estado de vinculación en tiempo real. Se ocultan o desactivan las plataformas desconectadas en las tablas y se bloquea el envío o edición desincronizada.
...
- **[IMPROVEMENT] [LOGGING] Loggers Jerárquicos Modulares Dedicados:** Estandarización de logging profesional con nombres de módulo canónicos, telemetría de arranque detallada y filtrado de librerías externas para mantener los registros limpios y legibles.
- **[IMPROVEMENT] [UI] Ajuste de Geometría y Alineación de Diálogos Modales:** Sincronización precisa de dimensiones en diálogos antes del centrado en pantalla, eliminando advertencias nativas de Windows.
...
- **[IMPROVEMENT] [REPORTS] Identificación de Usuario y Versión en Logs de Reportes:** Los archivos de log adjuntos en los reportes de bugs y crashes enviados a Discord ahora llevan el nombre de usuario y versión en su nombre de archivo junto a un encabezado identificativo con el sistema operativo y severidad.
